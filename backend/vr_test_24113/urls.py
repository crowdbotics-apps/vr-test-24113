"""vr_test_24113 URL Configuration
...
admin.site.site_header = "vr_test"
admin.site.site_title = "vr_test Admin Portal"
admin.site.index_title = "vr_test Admin"

# swagger
api_info = openapi.Info(
    title="vr_test API",
    default_version="v1",
    description="API documentation for vr_test App",
)
